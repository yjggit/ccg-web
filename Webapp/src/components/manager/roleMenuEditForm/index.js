...
class RoleMenuEditForm extends PureComponent {
    state = {
                ...
                >
                    ...
                    >
                        {getFieldDecorator('roleId', {
                            initialValue: item ? item.roleId : '',
                            // rules: [{
                            //     required: true, message: '请输入角色名称',
                            // }],
                        })(
                            <Input placeholder={item.roleId} disabled='false' />
                        )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
...
RoleMenuEditForm = Form.create({})(RoleMenuEditForm)
export default RoleMenuEditForm;
