...
class IndexCont2 extends Component {
    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: '#FFF' }} id="top">
                ...
                <div className="bg_bannerLoginAfterBox" >
                    <div>
                        <div className="bg_bannerLoginAfterImage"></div>
                        <div className="bg_bannerLoginAfterBtn">
                            <ul>
                                <li>
                                    <NavLink to={"/search/builderCompositeSearch"}>组合查询</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/builderSimpleSearch"}>企业查询</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/builderPersonSearch"}>人员查询</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/BuilderPerformSearch"}>业绩查询</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/enterpriseBidInviteSearch"}>招标公告</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/enterpriseBidResultSearch"}>中标信息</NavLink>
                                </li>
                                <li>|</li>
                                <li>
                                    <NavLink to={"/search/BuilderCreditSearch"}>信用查询</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="gcez_containter">
                        ...
                        <NavLink to={"/search/enterpriseBidInviteSearch"}  className='ddgo_index_A'>
                            <div className="gcez_iconList">
                                ...
                                <div className="gcez_iconTitel">
                                    {/*<Badge style={{marginLeft: 100}} count={<span>免费</span>}>*/}
                                    <h3>招标公告</h3>
                                    {/*</Badge>*/}
                ...
                <div className="gcez_sale" style={{background: "url(" + require("./../images/gcez_adv.jpg") + ") no-repeat center top", width: '100%', height: 320}}> </div>
                ...
                <div className="gcez_tender">
                    <div className="gcez_containter">
                        ...
                        <div className="gcze_moreBtn"><NavLink to={"/search/enterpriseBidInviteSearch"}>查看更多</NavLink></div>
                    </div>
                </div>
                                ...
                                return (
                                    <div className="gcez_winList">
                                        ...
                                        <div>
                                            ...
                                            <p><span>中标企业：</span>{result.builderName || '无'}</p>{/**公路工程 */}
                                        </div>
                                    </div>
                                );
                            })}
                        </div>
                        <div className="gcze_moreBtn"><NavLink to={"/search/enterpriseBidResultSearch"}>查看更多</NavLink></div>
                    </div>
                </div>
...
IndexCont2.contextTypes = {
    router: PropTypes.object.isRequired
};
export default IndexCont2;
